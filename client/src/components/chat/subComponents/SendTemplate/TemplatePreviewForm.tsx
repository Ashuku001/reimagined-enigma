...
import { PhoneIcon, GlobeAltIcon, ArrowUpLeftIcon } from '@heroicons/react/24/outline'
...
import { componentIndex } from '@/lib/generateTemplatePreview/tempalatePreviewObject'

import { useTemplateModal } from '@/hooks/useTemplateModal';
import { Models } from 'appwrite';
import { useFileStore } from '@/store/FileStore';
import { getFileDownloadUrl } from '@/lib/appwrite/getFIleUrl';
import { uploadFile } from '@/lib/appwrite/uploadFile';
import { ReturnedChat } from '@/__gql__/graphql';
...
const icons: IconsType = { PHONE_NUMBER: <PhoneIcon className='h-4 w-4 mr-2' />, URL: <GlobeAltIcon className='h-4 w-4 mr-2' />, QUICK_REPLY: <ArrowUpLeftIcon className="h-4 w-4 mr-2"/> }
