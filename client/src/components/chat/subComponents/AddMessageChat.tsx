    ...
    const handleSubmit = (e: FormEvent<HTMLFormElement>) => {
        ...
        addTextMessage({
            ...
            update: (store, { data: { addTextMessage } }) => {
                ...
                const newMessage = {...addTextMessage, context :  null, document :  null, image :  null, interactive :  null, isAd :  null, mesBtnReply :  null, mesListReply :  null, mesTempReply :  null, messageAd :  null, messageId :  null, status :  null, video :  null,}
                if(data?.chat?.messages?.slice(-1)[0]?.id !== addTextMessage.id){
                    data = {...data, chat: {
                        ...data?.chat,
